...
> 版本：1.9　作者：chiangyang　更新：2026-09-19
...
| 快捷键自定义 | 已完成：31 项快捷键集中于 `src/shortcuts.ts`，设置面板可改键（捕获 / 合法性校验 / 冲突检测 / 恢复默认），主进程菜单与编辑器读同一份配置（见 §14） | — |
...
> **版本历史**
>
> - 2026-09-19　新增 §29-§34（标签页右键菜单 / 拼写检查开关 / 侧边栏分隔条 / 静态模板装配 / 菜单模板工厂 / 启动 JS 减重懒加载）；「已知限制」重编号 §35
